...
{items_html}
    ...
    article_schema = {
      ...
      "description": f"Discover the career highlights and statistics for {name}, the featured New York Yankee for the {formatted_date} trivia puzzle.",
...
def build_quiz_page_html(player_data: dict, date_str: str, formatted_date: str) -> str:
    """Builds and returns the HTML for the static quiz page."""
    game_schema = {
        "@context": "https://schema.org",
        "@type": "VideoGame",
        "name": f"Name That Yankee Quiz - {formatted_date}",
        "description": f"Test your knowledge! Can you name this New York Yankee based on their career stats from {formatted_date}?",
        "genre": "Trivia",
        "author": {"@type": "Person", "name": "Scott Zager"},
        "image": "https://namethatyankeequiz.com/images/social-card.webp",
        "url": f"https://namethatyankeequiz.com/{date_str}-quiz"
    }
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Name That Yankee Quiz - {formatted_date}</title>
    <link rel="stylesheet" href="style.css">
    <link rel="manifest" href="manifest.json">
    <link rel="shortcut icon" type="image/png" href="images/favicon.png">
    <link rel="apple-touch-icon" sizes="180x180" href="apple-touch-icon.png">
    ...
    <meta property="og:description" content="Check out this Name That Yankee puzzle! Can you name this player based on their career stats from {formatted_date}?">
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="Name That Yankee">
    <meta property="og:image" content="https://namethatyankeequiz.com/images/social-card.webp">
    
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Name That Yankee Quiz - {formatted_date}">
    <meta name="twitter:description" content="Check out this Name That Yankee puzzle! Can you name this player based on their career stats?">
    <meta name="twitter:image" content="https://namethatyankeequiz.com/images/social-card.webp">
...
<body>
    <header>
        <div class="header-content">
            <h1 id="quiz-title">Name That Yankee Quiz - {formatted_date}</h1>
        </div>
        <div class="header-controls">
            <a href="instructions" class="instructions-link">New Features!</a>
            <div id="score-display">
        ...
        <div class="quiz-layout">
            <div class="left-column">
                <div class="quiz-container" id="quiz-area">
                    <img id="clue-image" src="images/clue-{date_str}.webp" alt="Trivia Clue">
                    <div class="autocomplete-container">
                        <input type="text" id="guess-input" aria-label="Enter player's name"
                            placeholder="Enter player's name..." autofocus>
                    ...
                    <div id="share-fail-container" style="display: none; margin-top: 1rem;">
                        <button id="share-btn-fail" class="share-button">Share Results ⚾</button>
                    </div>
                ...
                <div class="quiz-container" id="success-area" style="display: none;">
                    ...
                    <div class="success-actions">
                        <button id="share-btn-success" class="share-button">Share Results ⚾</button>
                        <a id="view-answer-link" href="{date_str}" class="view-details-link">View Player Details</a>
                    </div>
                </div>
            </div>
...
def generate_detail_page(player_data: dict, date_str: str, formatted_date: str, project_dir: Path):
    """Generates and saves the new HTML detail page and static quiz page."""
    print(f"  📄 Generating pages for {date_str}...")
    
    # 1. Answer Page
    answer_html = build_detail_page_html(player_data, date_str, formatted_date)
    answer_path = project_dir / f"{date_str}.html"
    with open(answer_path, 'w', encoding='utf-8') as f:
        f.write(answer_html)
    
    # 2. Quiz Page
    quiz_html = build_quiz_page_html(player_data, date_str, formatted_date)
    quiz_path = project_dir / f"{date_str}-quiz.html"
    with open(quiz_path, 'w', encoding='utf-8') as f:
        f.write(quiz_html)
        
    print(f"  ✅ Pages saved successfully.")
